...
5. Prueba las siguientes instrucciones:
   ...
   e. ¿Existe una anomalía de pagos para la orden 002d82fb-ccff-4b81-8556-d59563b97a9f? Una anomalía de pagos se define como la situación en la que el valor total de los pagos es diferente al valor de una orden cuyo estado es Completada.
