...
Si no estás siguiendo toda la secuencia de laboratorios, aquí solo se usa una base SQL para consultas del Lab 5 (Julie). Puedes apuntar directamente a una base SQL standalone (por ejemplo Azure SQL Database) usando:
