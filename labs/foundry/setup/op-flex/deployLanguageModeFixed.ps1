...
# ============================================================================
# Uso:
#   .\deployLanguageModeFixed.ps1
#   .\deployLanguageModeFixed.ps1 -FabricWarehouseSqlEndpoint "<endpoint-sql-fabric>" -FabricWarehouseDatabase "<database>"
#   .\deployLanguageModeFixed.ps1 -Location "eastus" -FabricWarehouseSqlEndpoint "<endpoint-sql-fabric>" -FabricWarehouseDatabase "<database>"
