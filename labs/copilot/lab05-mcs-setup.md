...
- Ve a la consola de administración de Power Platform  y selecciona la opción “Manage” en la barra lateral izquierda  
![imagen](img/image1_MCS_Setup.png)
Haz clic en la opción Environments: 
![imagen](img/image2_MCS_Setup.png)
1. Selecciona “New” para crear un nuevo entorno: 
...
En este laboratorio, aprenderás a armar una solución (Solution), el vehículo oficial de implementación para tus agentes de Microsoft Copilot Studio. Piensa en esto como crear un maletín digital que contiene tu agente y sus artefactos/componentes. 
...
Manos a la obra. 
Ve a Copilot Studio. 
Asegúrate de estar en el entorno correcto (Environment) = **MultiAgentWrkshp** 
![imagen](img/image13_MCS_Setup.png)
Haz clic en “…” en el menú de la barra izquierda. 
![imagen](img/image14_MCS_Setup.png)
## Selecciona **Solutions**
![imagen](img/image15_MCS_Setup.png)
Esto abrirá una nueva pestaña en tu navegador. 
Vamos a crear una <u>Solution</u> 
Se cargará el **Solution Explorer** en Copilot Studio. Selecciona **+ New solution** 
![imagen](img/image16_MCS_Setup.png)
Aparecerá el panel New solution, donde podremos definir los detalles de nuestra solución. 
...
Si quieres proporcionar los datos de contacto de la solución, selecciona la pestaña **Contact** y completa las columnas que se muestran. 
![imagen](img/image20_MCS_Setup.png)
Selecciona la pestaña **Properties** y selecciona **Save** para crear el publisher. 
![imagen](img/image21_MCS_Setup.png)
El panel New publisher se cerrará y volverás al panel **New solution** con el publisher recién creado seleccionado. 
Bien hecho, ¡ya creaste un Solution Publisher! 🙌🏼 A continuación aprenderemos a crear una nueva solución personalizada. 
Ahora que tenemos el nuevo Solution Publisher, podemos completar el resto del formulario en el panel **New solution** .. 
Copia y pega lo siguiente: 
...
Los dejaremos en blanco para este laboratorio. 
![imagen](img/image22_MCS_Setup.png)
Selecciona **Create**. 
![imagen](img/image23_MCS_Setup.png)
La solución **My Multi Agent Solution** ya se creó. No habrá componentes hasta que creemos un agente en Copilot Studio. 
![imagen](img/image24_MCS_Setup.png)
Selecciona el ícono de flecha hacia atrás para volver al Solution Explorer. 
![imagen](img/image25_MCS_Setup.png)
Haz que tu solución sea la solución predeterminada / Confírmalo 
Verifica que tu solución “” tenga la etiqueta “Preferred Solution” al lado. 
![imagen](img/image26_MCS_Setup.png)
Si no es así, selecciona los puntos suspensivos “…” junto a tu solución y luego selecciona la opción “Set preferred solution” en el menú desplegable, como se muestra a continuación: 
![imagen](img/image27_MCS_Setup.png)
En la ventana emergente, haz clic en la lista desplegable y selecciona tu solución “**MyMultiAgentSln**” 
![imagen](img/image28_MCS_Setup.png)
Haz clic en “Apply” para confirmar que quieres establecer tu solución “**MyMultiAgentSln**” como la solución preferida. 
![imagen](img/image29_MCS_Setup.png)
Ahora tu solución “**MyMultiAgentSln**” debe tener la etiqueta “Preferred solution” al lado. 
![imagen](img/image26_MCS_Setup.png)
**🎉**** Misión completada **
